...
//初始化，接收参数
 ...
 var w = ($(window).width()-this.config.width)/2*screenSize;

 var h = ($(window).height()-this.config.height)/2*screenSize;
...
var bgDiv = "<div id='zz' style='display: none;position: absolute;top: 0px;left: 0px;right:0px;background-color: #eee;opacity: 0.6;'></div>";
    $("body").append(bgDiv);
    $("#zz").css('width',document.body.offsetwidth + "px");
    $("#zz").css('height',screen.height + "px");
 $("#zz").css('display','block');
